...
import 'package:biit_social/screens/auth/screens/SVResetPasswordScreen.dart';
        ...
        child: Column(
          children: [
            ...
            Text('00:${counter.toString()}',
                style: boldTextStyle(size: 14, color: const Color(0xFF3AB74E))),
            20.height,
            Row(
            ...
            svAppButton(
              ...
              text: 'VERIFY NOW',
              onTap: () {
                const SVResetPasswordScreen().launch(context);
              },
            ),
          ],
        ),
